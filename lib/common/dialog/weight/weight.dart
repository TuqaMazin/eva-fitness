                            ...
                            child: SizedBox(
                              ...
                              child: CupertinoPicker(
                                ...
                                scrollController: isFromCurrentWeight
                                    ...
                                    : logic.fixedExtentScrollControllerTargetWeight,
                                ...
                                selectionOverlay: Container(
                                  decoration: const BoxDecoration(
                                    border: Border(
                                      top: BorderSide(width: 0.5, color: AppColor.primary),
                                      bottom: BorderSide(width: 0.5, color: AppColor.primary),
                                    ),
                                  ),
                                ),
                      ...
                      child: TextButton(
                        ...
                        onPressed: () {
                          if (isFromCurrentWeight) {
                            ...
                            _myProfileController.onTargetWeightSaveButtonClick();
                          }
                        },
                      ),
                    ),
